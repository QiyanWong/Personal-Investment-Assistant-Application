...
foreach ($stocklist as $tmp) {
	...
	$csv_path="/Users/ShuoFan/Desktop/se2project/Data/hist_data/$tmp-hist-$month-$day-$year.csv";
...
foreach ($stocklist as $tmp) {
	...
	$csv_path="/Users/ShuoFan/Desktop/se2project/Data/real_data/$tmp-$month-$day-$year.csv";
	$sql = <<<eof
